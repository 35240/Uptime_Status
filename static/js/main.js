/*! For license information please see main.4a0f818c.js.LICENSE.txt */ ! function(e) {
    ...
    function(e, t, n) {
        ...
        function It(e, t) {
            ...
            } else 0 !== (a = n & ~i) ? (r = At(a), o = zt) : 0 !== l && (r = At(l), o = zt); if (0 === r) return 0;
            ...
            if (null !== i) {
                for (d = a.baseState, l = 0, f = c = s = null;;) {
                    ...
                    if ((r & u) === u) {
                        ...
                        callback: i.callback,
                        next: null
                    }, null === f ? (c = f = p, s = d) : f = f.next = p, l |= u; if (null === (i = i.next)) {
        ...
        function Bi(e, t, n, r, o) {
            if (mo(n)) {
                var a = !0;
                bo(t)
            } else a = !1; if (ra(t, o), null === t.stateNode) null !== e && (e.alternate = null, t.alternate = null, t.flags |= 2), ga(t, n, r), ba(t, n, r, o), r = !0;
            else if (null === e) {
                var i = t.stateNode,
                    l = t.memoizedProps;
                i.props = l;
        ...
        function vu(e) {
            ...
            } else n = Su(e, t = It(e, 0)); if (0 !== e.tag && 2 === n && (Ll |= 64, e.hydrate && (e.hydrate = !1, Wr(e.containerInfo)), 0 !== (t = Ut(e)) && (n = Su(e, t))), 1 === n) throw n = zl, ku(e, 0), mu(e, t), pu(e, $o()), n;
        ...
        function Pu(e, t) {
            ...
            if (null !== tu && 0 === (24 & r) && tu.has(e) && tu.delete(e), e === Pl && (Nl = Pl = null, jl = 0), 1 < n.flags ? null !== n.lastEffect ? (n.lastEffect.nextEffect = n, r = n.firstEffect) : r = n : r = n.firstEffect, null !== r) {
                ...
                ql = null, zo(), Ll = o
            } else e.current = n; if (Xl) Xl = !1, Gl = e, Jl = t;
            else
                for (ql = r; null !== ql;) t = ql.nextEffect, ql.nextEffect = null, 8 & ql.flags && ((x = ql).sibling = null, x.stateNode = null), ql = t; if (0 === (r = e.pendingLanes) && (Kl = null), 1 === r ? e === ru ? nu++ : (nu = 0, ru = e) : nu = 0, n = n.stateNode, Eo && "function" === typeof Eo.onCommitFiberRoot) try {
        ...
        var c = n(0),
            ...
            d = function() {
                ...
                return Object(c.jsx)("header", {
                    ...
                    children: [
                        Object(c.jsx)("div", {
                        className: "cover normal fade-enter-done"
                        }),
                        Object(c.jsxs)("div", {
                        className: "container",
                        children: [
                ...
                return Object(c.jsx)("footer", {
                    ...
                    children: Object(c.jsxs)("div", {
                        ...
                        children: [Object(c.jsxs)("p", {
                            ...
                            children: ["Copyright © 2024 - ",y," ", Object(c.jsx)(f, {
                                className: "link",
                                to: "https://nuoxiana.cn",
                                text: "nuoxian"
                            }), " | ", Object(c.jsx)(f, {
                                className: "link",
            ...
            ue = function(e) {
                var t = e.data,
                    n = Object(r.useMemo)((function() {
                        ...
                        return t.uptime >= 100 ? (e = "line normal", n += " 可用率 ".concat(le(t.uptime), "%")) : t.uptime <= 0 && 0 === t.down.times ? (e = "line none", n += " 无数据") : (e = "line error", n += " 故障 ".concat(t.down.times, " 次，累计 ").concat(ie(t.down.duration), "，可用率 ").concat(le(t.uptime), "%")), {
                            status: e,
                            text: n
                        }
                    }), [t]),
            ...
            se = function(e) {
                var t = window.Config,
                    ...
                    i = Object(r.useMemo)((function() {
                        return a.total.times ? "最近 ".concat(o, " 天内故障 ").concat(a.total.times, " 次，累计 ").concat(ie(a.total.duration), "，平均可用率 ").concat(a.average, "%") : "最近 ".concat(o, " 天内可用率 ").concat(a.average, "%")
                    }), [o, a]),
                    l = Object(r.useMemo)((function() {
                        return a.daily[a.daily.length - 1].date
                    }), [a]);
                return Object(c.jsxs)("div", {
                    className: "site normal",
                    children: [Object(c.jsxs)("div", {
                        className: "meta",
                        children: [Object(c.jsxs)("div", {
                            className: "name",
        ...
        var pe = n(7),
                        ...
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 12:
                                return f = e.sent, d = [], f.forEach((function(e) {
                                    ...
                                    var l = "unknow";
                                    2 === e.status && (l = "normal"), 9 === e.status && (l = "error"), d.push({
                                        id: e.id,
            ...
            be = function() {
                ...
                return Object(r.useEffect)((function() {
                    ...
                    children: [Object(c.jsx)(d, {}), Object(c.jsx)("main", {
                        id: "main",
                        children: Object(c.jsxs)("div", {
                            className: "container",
                            children: [
                                ...
                                children: [
                                    Object(c.jsxs)("div", {
                                    className: "sites fade-enter-done",
